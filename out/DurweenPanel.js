...
class DurweenPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel('durween', 'Durween', column || vscode.ViewColumn.One, {
            enableScripts: true,
     ...
     */
    static speak(message, mood = 'happy') {
        if (DurweenPanel.currentPanel) {
...
exports.DurweenPanel = DurweenPanel;
//# sourceMappingURL=DurweenPanel.js.map