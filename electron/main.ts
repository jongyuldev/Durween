...
let clippyWindow: BrowserWindow | null;
...
app.whenReady().then(() => {
    ...
    // IPC Handlers
    ipcMain.on('set-ignore-mouse-events', (event: Electron.IpcMainEvent, ignore: boolean, options?: Electron.IgnoreMouseEventsOptions) => {
